...
cycle;idx;time_ms;iter_mV;iter_V;code_set;ao_V;AI0;AI1;AI2;AI3;AI4;AI5;AI6;AI7
...
cycle;idx;time_ms;iter_mV;iter_V;code_set;ao_V;AI0;...;AI7


Отладочный вывод в stdout:

одна строка: cycle=… idx=… AO=… AI=[AI0 ... AI7].
...
start_mV=-5000     # начальное значение AO0 в милливолтах
end_mV=5000        # конечное значение AO0 в милливолтах
step_mV=100        # шаг по милливолтам
period_ms=100      # период одного шага итерации (мс)
settle_ms=50       # время стабилизации перед измерением (мс)
...
0;0;12.345;-5000;-5.000000;0;-5.000000;0.001234;0.001235;...;0.001240


cycle — сейчас всегда 0 (пока реализован один проход; в будущем — счётчик циклов);

idx — номер шага внутри прохода;
...
счётчик cycle в CSV и на stdout.
